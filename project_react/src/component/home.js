                                    ...
                                    <form action="index.html" method="get" className="tm-search-form tm-section-pad-2">
                                        <div className="form-row tm-search-form-row">
                                            <div className="form-group tm-form-group tm-form-group-pad tm-form-group-1">
                                                ...
                                                <input onChange={(event) => setdes(event.target.value)} name="destination" type="text" className="form-control" id="inputCity" placeholder="Type your destination..." />
                                            </div>
                                        ...
                                        <div className="form-row tm-search-form-row">
                                            ...
                                            <div className="form-group ">
                                                <label for="inputCheckIn">Check Date</label><br/>
                                            ...
                                            <div className="form-group tm-form-group tm-form-group-pad">
                                                ...
                                                <Link  
                                                   ...
                                                   state = {{destination : destination,
                                                            ...
                                                            (state[0].endDate.getMonth()+1).toString()+"."+
                                                            state[0].endDate.getDate().toString()}} 
                                                    ><button style={{ "width": "400%" }} type="button" onClick={(e)=>{checkstat()}} className="btn btn-primary tm-btn tm-btn-search text-uppercase" id="btnSubmit">검색</button>
                                                </Link>
                                            </div>
                                        </div>
                                    </form>
